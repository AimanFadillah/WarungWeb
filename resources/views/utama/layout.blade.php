...
<html lang="en">
  ...
  <body >
    ...
    {{-- navbar --}}
    <nav class="navbar navbar-dark fixed-top p-3" style="background-color: #0081C9" >
        <div class="container-fluid">
          <a class="navbar-brand fw-bold"  href="/">Warung<span style="color: #F5EA5A" >Tukang</span></a>
          <button class="navbar-toggler" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasNavbar" aria-controls="offcanvasNavbar">
            <span class="navbar-toggler-icon"></span>
          </button>
          <div class="offcanvas offcanvas-end" style="background-color: #0081C9 " tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
              ...
              <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                ...
                <li class="nav-item mt-3">
                  <form action="/logout" method="POST" >
                    @csrf
                    <button type="submit" class="fw-bold btn btn-light p-2" style="color: #0081C9" >Logout</button>
                  </form>
                </li>
                @else
                <li class="nav-item">
